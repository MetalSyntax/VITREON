                ...
                <div className="px-8 pt-10 pb-6 flex items-center justify-between border-b border-white/5">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-2xl bg-indigo-500/20 text-indigo-400 flex items-center justify-center">
                            <span className="material-symbols-rounded text-2xl">policy</span>
                        </div>
                        <h3 className="text-2xl font-black text-slate-800 dark:text-white tracking-tight">{t('privacyPolicy')}</h3>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto no-scrollbar px-10 py-8 space-y-8">
                    <section className="space-y-3">
                        <h4 className="font-bold text-lg text-slate-800 dark:text-white flex items-center gap-2">
                            <span className="material-symbols-rounded text-indigo-400">database</span> 
                            {t('localFirstStorage')}
                        </h4>
                    ...
                    <section className="space-y-3">
                        <h4 className="font-bold text-lg text-slate-800 dark:text-white flex items-center gap-2">
                            <span className="material-symbols-rounded text-indigo-400">cloud</span> 
                            {t('cloudSyncTitle')}
                        </h4>
                        <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                            {t('cloudSyncDesc')}
                    ...
                    <section className="space-y-3">
                        <h4 className="font-bold text-lg text-slate-800 dark:text-white flex items-center gap-2">
                            <span className="material-symbols-rounded text-indigo-400">delete_forever</span> 
                            {t('dataDeletionTitle')}
                        </h4>
                        <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                            {t('dataDeletionDesc')}
